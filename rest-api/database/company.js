...
module.exports = class Company {
    ...
    get_all(name) {
        if (name == undefined) {
            let command = 'SELECT company.*, security.figi_id, security.ticker FROM company LEFT JOIN security ON security.company_id=company.company_id'
     ...
     */
    get(company_id) {
        let command = 'SELECT company.*, security.figi_id, security.ticker FROM company LEFT JOIN security ON security.company_id=company.company_id WHERE company.company_id=$1'
